...
|--------------|--------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
|Yes, (V1,V2)| Wikipedia | Yes, [however!](https://www.theguardian.com/uk-news/2020/aug/26/shock-an-aw-us-teenager-wrote-huge-slice-of-scots-wikipedia) | Articles | [HF_Wikipedia](https://huggingface.co/datasets/wikipedia) [dumps.wikipedia](https://dumps.wikimedia.org/), [wili_2018](https://huggingface.co/datasets/wili_2018), [Leipzig](https://wortschatz.uni-leipzig.de/en/download) | CC BY-NC-SA 3.0 | 
|Yes, (V1,V2)| SETIMES | Yes | News | [Opus_SETIMES](https://opus.nlpl.eu/SETIMES.php) | CC-BY-SA 3.0 | 
|Yes, (V1,V2)| Tatoeba | Yes, mostly | Crowdsourcing | [Tatoeba](https://tatoeba.org/en/downloads) | CC-BY | 
|Yes, (V1,V2)| Global Voices | Yes | News stories | [Opus_GlobalVoices](https://opus.nlpl.eu/GlobalVoices-v2015.php) | CC BY 3.0 | 
|Yes, (V1,V2)| XL-Sum       | Yes          | BBC News            | [HF_xlsum](https://huggingface.co/datasets/csebuetnlp/xlsum), [Github_xlsum](https://github.com/csebuetnlp/xl-sum)                                                     | CC BY-NC-SA 4.0          |
|Yes, (V1,V2)| Leipzig - News and Newscrawl | Yes | News | [Leipzig](https://wortschatz.uni-leipzig.de/en/download) | CC BY-NC-SA 3.0 |
|Yes, (V1,V2)| NLLB_seed	| Yes | Professionally-translated sentences (Wikipedia domain) | [NLLB_Seed](https://github.com/facebookresearch/flores/blob/main/nllb_seed/README.md) | CC-BY-SA 4.0 |
|Yes, (V1,V2) |  MT-560v1 | ?, openlid version is much cleaner.  | Multiple domain | [OpenLID compilation](https://github.com/laurieburchell/open-lid-dataset) | Apache License 2.0 |
|Yes, (V1,V2) | Autshumato | Yes | Government domain | [HF_autshumato](https://huggingface.co/datasets/autshumato) | CC Attribution 2.5 South Africa License |
|Yes, (V1,V2)| Open Bibles  | Yes, but some closely related languages (or similar name) might be confused. | Bible versions | [1000Langs](https://github.com/ehsanasgari/1000Langs), [PBC](https://aclanthology.org/L14-1215/), [CorpusCrawler](https://github.com/google/corpuscrawler), [PNG](https://png.bible), [Open-Bibles](https://github.com/seven1m/open-bibles), [Bible.is](https://bible.is/), [ebible](https://github.com/BibleNLP/ebible), [biblenlp-corpus](https://huggingface.co/datasets/bible-nlp/biblenlp-corpus), [JHUBC](https://aclanthology.org/2020.lrec-1.352/), [bible.com](https://www.bible.com/) | Mostly CC BY-NC-ND |
|Yes (partly), (V1,V2)| JW          | Yes, except sign language codes | New World Bible    | [Masakhane-Mt](https://github.com/masakhane-io/masakhane-mt), [JW](https://www.jw.org), [JW300](https://aclanthology.org/P19-1310/)                                    | Usage for your own personal and non-commercial purposes is [permitted](https://www.jw.org/en/terms-of-use/). However, distribution is not allowed. |
|Yes (partly), (V1,V2)| LTI | ? | Multiple domain | [whatlang](https://www.cs.cmu.edu/~ralf/langid.html) | Custom License/ Open partly | 
|Yes (partly), (V1,V2)| Arabic (DART, SHAMI, TSAC, PADIC, AOC, Arabic Dialects Dataset, MADAR) | ? | Multiple domain | [IADD](https://github.com/JihadZa/IADD), [MADAR](https://camel.abudhabi.nyu.edu/madar-shared-task-2019/), [Arabic Dialects](https://www.lancaster.ac.uk/staff/elhaj/corpora.html) | Multiple open licenses|
|Yes, (V1,V2)| Persian (TEP, MIZAN) | Yes | literature, subtitle | [TEP](https://opus.nlpl.eu/TEP.php), [MIZAN](https://github.com/omidkashefi/Mizan) | TEP: GNU General Public License, MIZAN: CC BY 4.0 | 
|Yes, (V1,V2)| TIL Corpus | ? | Multiple domain | [TIL-MT](https://github.com/turkic-interlingua/til-mt) | CC BY-NC-SA 4.0 | 
|Yes, (V1,V2)| bho-resources | Yes | News | [bho-resources](https://github.com/shashwatup9k/bho-resources) | CC BY-NC-SA 4.0 | 
|Yes, (V1,V2)| Guaraní Parallel Set	 | Yes | News | [Guaraní Parallel Set](https://github.com/sgongora27/giossa-gongora-guarani-2021) | No explicit license | 
